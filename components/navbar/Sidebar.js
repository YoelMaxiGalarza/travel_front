...
export default function Sidebar() {
    ...
    return (<>
        <div className="sidebar d-flex flex-column flex-shrink-0 bg-body-tertiary"
             style={{width: "4.5rem",height:"100%",position:"fixed",zIndex: "99999"}} bis_skin_checked="1" >
            <Link href="/dashboard"
            ...
            <ul className="nav nav-pills nav-flush flex-column mb-auto text-center">
                ...
                <li>
                    <Link href="/dashboard/trips" className="nav-link p3 border-bottom rounded-0"
            ...
            <div className="dropdown border-top" bis_skin_checked="1">
                ...
                <ul className="dropdown-menu text-small shadow">
                    ...
                    <li><Link className="dropdown-item" href="/logout">{t("logout")}</Link></li>
                </ul>
            </div>
        </div>
    </>)
